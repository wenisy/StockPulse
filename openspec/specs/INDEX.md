...
| [portfolio-codebase-layout](./portfolio-codebase-layout/spec.md) | src/lib/portfolio/ 纯函数库目录结构契约、lib 层依赖方向约束（禁止依赖 React/Next/hooks/components）、hooks 必须通过 lib 完成领域计算、删除重复实现的约束 | 5 |
